        ...
        <CardContent>
          ...
          {step === 2 && (
            <div className="max-w-md mx-auto space-y-6">
              <div>
                <label htmlFor="franchise-name" className="block text-sm font-medium text-gray-700 mb-2">
                  Franchise Name
                </label>
                <input
                  type="text"
                ...
                <p className="mt-2 text-sm text-gray-500">
                  This is how you'll identify this save file. You can create multiple franchises.
                </p>
              </div>

              {selectedTeam && (
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="text-sm font-medium text-gray-700 mb-2">Selected Team</p>
            ...
            <div className="max-w-2xl mx-auto space-y-4">
              ...
              {selectedTeam && (
                <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="text-sm font-medium text-gray-700 mb-2">Franchise Summary</p>
...
function DifficultyOption({ title, description, isSelected, onSelect }: DifficultyOptionProps) {
  return (
    <button
      type="button"
      onClick={onSelect}
